...
@JsonPropertyOrder({ "firstName", "middleName", "lastName", "userId", "password", "confPassword", "email", "mobile",
		"isAgent" })
public class UserDetailsBean {
	...
	public int hashCode() {
		...
		result = prime * result + (isAgent ? 1231 : 1237);
	...
	public String toString() {
		...
		builder.append("UserDetailsBean [firstName=");
